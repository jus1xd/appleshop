...
function loginPage() {
  ...
  const [passwordError, setPasswordError] = useState<string>('Пароль некорректный');
        ...
        <div className={s.container}>
          <div className={s.log_inner}>
            ...
            <div className={s.register}>
              ...
              <input
                className={emailDirty && emailError ? `${s.reg} ${s.error}` : s.reg}
                type="text"
                name="email"
              ...
              />
              <input
                className={passwordDirty && passwordError ? `${s.reg} ${s.error}` : s.reg}
                type="password"
                name="password"
